    ...
    <div className="min-w-full" style={{ ['--grid-cols' as any]: gridCols }}>
     ...
     {[
      ...
      <div key={key} className="grid hover:bg-gray-50/50 transition-colors" style={{ gridTemplateColumns: 'var(--grid-cols)' }}>
       ...
       <div className="px-4 py-2.5 text-right text-sm font-bold text-gray-800 bg-gray-50/50">{calcularTotalesFila(datos, key).toLocaleString('en-US', { minimumFractionDigits: 2 })}</div>
      </div>
     ))}
     <div className="grid" style={{ gridTemplateColumns: 'var(--grid-cols)' }}>
      ...
      {tiendas.map((_, i) => {
       ...
       return <div key={i} className={"px-4 py-2.5 text-right text-sm border-r border-gray-100 " + getColorVariacion(val)}>{(val * 100).toFixed(2)}%</div>
      })}
      <div className={"px-4 py-2.5 text-right text-sm font-bold bg-gray-50/60 " + getColorVariacion(calcularTotalesFila(datos, 'presupuestoVentas') > 0 ? (calcularTotalesFila(datos, 'ventaNeta') / calcularTotalesFila(datos, 'presupuestoVentas')) - 1 : 0)}>
     ...
     <div className="grid" style={{ gridTemplateColumns: 'var(--grid-cols)' }}>
      ...
      <div className={"px-4 py-2.5 text-right text-sm font-bold bg-gray-50/60 " + getColorVariacion(calcularTotalesFila(datos, 'ventas2025') > 0 ? (calcularTotalesFila(datos, 'ventaNeta') / calcularTotalesFila(datos, 'ventas2025')) - 1 : 0)}>
     ...
     {[
      ...
      <div key={key} className="grid hover:bg-gray-50/50 transition-colors" style={{ gridTemplateColumns: 'var(--grid-cols)' }}>
       ...
       <div className="px-4 py-2.5 text-right text-sm font-bold text-gray-800 bg-gray-50/50">{calcularTotalesFila(datos, key).toLocaleString('en-US', { minimumFractionDigits: 0 })}</div>
      </div>
     ))}
     <div className="grid" style={{ gridTemplateColumns: 'var(--grid-cols)' }}>
      <div className="px-5 py-2.5 text-sm font-medium text-gray-500 bg-gray-50/60 border-r border-gray-100">Variación vs PPTO</div>
      ...
      <div className={"px-4 py-2.5 text-right text-sm font-bold bg-gray-50/60 " + getColorVariacion(calcularTotalesFila(datos, 'presupuestoTransacciones') > 0 ? (calcularTotalesFila(datos, 'transaccionesActuales') / calcularTotalesFila(datos, 'presupuestoTransacciones')) - 1 : 0)}>
     ...
     <div className="grid" style={{ gridTemplateColumns: 'var(--grid-cols)' }}>
      ...
      <div className={"px-4 py-2.5 text-right text-sm font-bold bg-gray-50/60 " + getColorVariacion(calcularTotalesFila(datos, 'transacciones2025') > 0 ? (calcularTotalesFila(datos, 'transaccionesActuales') / calcularTotalesFila(datos, 'transacciones2025')) - 1 : 0)}>
     ...
     <div className="grid hover:bg-gray-50/50 transition-colors" style={{ gridTemplateColumns: 'var(--grid-cols)' }}>
      ...
      {tiendas.map((_, i) => {
       ...
       return <div key={i} className="px-4 py-2.5 text-right text-sm bg-amber-50/40 border-r border-gray-100">{val.toFixed(2)}</div>
      })}
     ...
     <div className="grid hover:bg-gray-50/50 transition-colors" style={{ gridTemplateColumns: 'var(--grid-cols)' }}>
      ...
      <div className="px-4 py-2.5 text-right text-sm font-bold text-gray-800 bg-gray-50/50">{calcularTotalesFila(datos, 'presupuestoTicket').toFixed(2)}</div>
     </div>
     <div className="grid" style={{ gridTemplateColumns: 'var(--grid-cols)' }}>
      <div className="px-5 py-2.5 text-sm font-medium text-gray-500 bg-gray-50/60 border-r border-gray-100">Variación vs PPTO</div>
      {tiendas.map((_, i) => {
      ...
      <div className={"px-4 py-2.5 text-right text-sm font-bold bg-gray-50/60 " + getColorVariacion((() => { const tv = calcularTotalesFila(datos, 'ventaNeta'); const tx = calcularTotalesFila(datos, 'transaccionesActuales'); const tt = tx > 0 ? tv / tx : 0; const tp = calcularTotalesFila(datos, 'presupuestoTicket'); return tp > 0 ? (tt / tp) - 1 : 0; })())}>
      ...
      <div key={key}>
       ...
       <div className="grid" style={{ gridTemplateColumns: 'var(--grid-cols)' }}>
        ...
        {tiendas.map((_, i) => {
         ...
         return <div key={i} className="px-4 py-2 text-right text-xs text-gray-500 border-r border-gray-100">{(val * 100).toFixed(2)}%</div>
        })}
        <div className="px-4 py-2 text-right text-xs font-bold text-gray-500 bg-gray-50/40">
       ...
       {key !== 'notasCreditoCantidad' && (
        <div className="grid" style={{ gridTemplateColumns: 'var(--grid-cols)' }}>
         ...
         {tiendas.map((_, i) => {
          ...
          return <div key={i} className="px-4 py-2 text-right text-xs text-gray-500 border-r border-gray-100">{(val * 100).toFixed(3)}%</div>
         })}
         <div className="px-4 py-2 text-right text-xs font-bold text-gray-500 bg-gray-50/40">
     ...
     {[
      ...
      <div key={key} className="grid hover:bg-gray-50/50 transition-colors" style={{ gridTemplateColumns: 'var(--grid-cols)' }}>
       ...
       <div className="px-4 py-2.5 text-right text-sm font-bold text-gray-800 bg-gray-50/50">{calcularTotalesFila(datos, key).toLocaleString('en-US', { minimumFractionDigits: key === 'theVault' ? 2 : 0 })}</div>
      </div>
     ))}
       ...
       {key === 'empleadosActivos' && (
        <div className="grid" style={{ gridTemplateColumns: 'var(--grid-cols)' }}>
         ...
         {tiendas.map((_, i) => {
          ...
          return <div key={i} className="px-4 py-2 text-right text-xs text-gray-500 border-r border-gray-100">{val.toFixed(2)}</div>
         })}
         <div className="px-4 py-2 text-right text-xs font-bold text-gray-500 bg-gray-50/40">
     ...
     {[
      ...
      <div key={key} className="grid hover:bg-gray-50/50 transition-colors" style={{ gridTemplateColumns: 'var(--grid-cols)' }}>
       ...
       <div className="px-4 py-2.5 text-right text-sm font-bold text-gray-800 bg-gray-50/50">{calcularTotalesFila(datos, key).toFixed(2)}%</div>
      </div>
     ))}
     <div className="grid" style={{ gridTemplateColumns: 'var(--grid-cols)' }}>
      ...
      <div className={"px-4 py-2.5 text-right text-sm font-bold bg-gray-50/60 " + getColorVariacion(calcularTotalesFila(datos, 'costoSemanal') - calcularTotalesFila(datos, 'costoTeorico'))}>
     ...
     {[
      ...
      <div key={key} className="grid hover:bg-gray-50/50 transition-colors" style={{ gridTemplateColumns: 'var(--grid-cols)' }}>
       ...
       <div className="px-4 py-2.5 text-right text-sm font-bold text-gray-800 bg-gray-50/50">{calcularTotalesFila(datos, key).toLocaleString('en-US', { minimumFractionDigits: key === 'penalizacionesPct' ? 2 : 0 })}</div>
      </div>
     ))}
