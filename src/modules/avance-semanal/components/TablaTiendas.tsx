...
export default function TablaTiendas({ gerente, tiendas, datos, onUpdateDato }: TablaTiendasProps) {
 ...
 <div className="px-4 py-2.5 text-right text-base font-bold text-gray-800 bg-gray-50/50">{calcularTotalesFila(datos, key).toLocaleString('en-US', { minimumFractionDigits: 2 })}</div>
 </div>
 ))}
 ...
 return <div key={i} className="px-4 py-3 text-right text-base bg-amber-50/40 border-r border-gray-100">{val.toFixed(2)}</div>
 })}
 ...
 <div className="px-4 py-2.5 text-right text-base font-bold text-gray-800 bg-gray-50/50">{calcularTotalesFila(datos, 'presupuestoTicket').toFixed(2)}</div>
 </div>
 <div className="grid" style={{ gridTemplateColumns: 'var(--grid-cols)' }}>
 <div className="px-5 py-2.5 text-base font-medium text-gray-500 bg-gray-50/60 border-r border-gray-100">Variación vs PPTO</div>
 {tiendas.map((_, i) => {
 ...
 <div className="grid" style={{ gridTemplateColumns: 'var(--grid-cols)' }}>
 <div className="px-5 py-2 text-base text-gray-400 bg-gray-50/40 border-r border-gray-100">%</div>
 {tiendas.map((_, i) => {
 ...
 <div className="px-4 py-2.5 text-right text-base font-bold text-gray-800 bg-gray-50/50">{calcularTotalesFila(datos, key).toLocaleString('en-US', { minimumFractionDigits: key === 'theVault' ? 2 : 0 })}</div>
 </div>
 ))}
 ...
 {key === 'costoManoObra' && (
 <div className="grid" style={{ gridTemplateColumns: 'var(--grid-cols)' }}>
 <div className="px-5 py-2 text-base text-gray-400 bg-gray-50/40 border-r border-gray-100">% Mano de Obra</div>
 {tiendas.map((_, i) => {
 ...
 <div className="grid" style={{ gridTemplateColumns: 'var(--grid-cols)' }}>
 <div className="px-5 py-2 text-base text-gray-400 bg-gray-50/40 border-r border-gray-100">Productividad</div>
 {tiendas.map((_, i) => {
 ...
 <div className="px-4 py-2.5 text-right text-base font-bold text-gray-800 bg-gray-50/50">{calcularTotalesFila(datos, key).toLocaleString('en-US', { minimumFractionDigits: key === 'penalizacionesPct' ? 2 : 0 })}</div>
 </div>
 ))}
